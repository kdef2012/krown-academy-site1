  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 9999, background: "rgba(0,0,0,0.8)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ background: COLORS.white, borderRadius: 12, width: "100%", maxWidth: 600, maxHeight: "90vh", overflowY: "auto", position: "relative", boxShadow: "0 24px 60px rgba(0,0,0,0.4)" }}>
        ...
        <form action={`mailto:krownacademynelson@gmail.com?subject=Krown%20Academy%20Form%3A%20${encodeURIComponent(form.title)}`} method="post" encType="text/plain" style={{ padding: "32px" }}>
          <p style={{ fontSize: 14, color: COLORS.textMuted, marginBottom: 24, lineHeight: 1.6 }}>
            Please fill out the form below. When you click submit, it will securely open your email app to instantly send your responses directly to Kendall.
          </p>
          ...
          <div style={{ marginTop: 32, textAlign: "right", borderTop: `1px solid ${COLORS.lightGray}`, paddingTop: 24 }}>
            <Button type="submit" variant="primary">Submit Data Securely</Button>
          </div>
        </form>
      </div>
    </div>
...
const STUDENT_DATABASE = {
  "KNDL01": {
    ...
    creditsEarned: 16,
    creditsNeeded: 22,
    taken: ["English I", "English II", "Algebra I", "Geometry", "Earth Science", "Biology", "World History", "Civics", "Health/PE", "Spanish I", "Expressive Writing"],
    needed: ["English III", "English IV", "Algebra II", "4th Math", "Chemistry/Physical Science", "US History", "Economics/Personal Finance", "Spanish II"]
  }
};
...
function Curriculum() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    const student = STUDENT_DATABASE[studentId.toUpperCase()];
        ...
        {!loggedInStudent ? (
          <form onSubmit={handleLogin} style={{ maxWidth: 400, margin: "0 auto", background: COLORS.offWhite, padding: 32, borderRadius: 12 }}>
            ...
            <div style={{ textAlign: "center" }}>
              <Button type="submit" variant="dark" style={{ width: "100%" }}>Access Secure Records</Button>
            </div>
